<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Criteria.aspx.cs" Inherits="OilGasCompany.Interview.Admin.Criteria" %>
            ...
            <asp:Panel ID="panel_AddCriteria" runat="server">
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_AddCriteria" runat="server" Text="Add Criteria" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" OnClick="btn_AddCriteria_Click" />
                        </div>
                            ...
                            <asp:GridView ID="grdview_CriteriaList" runat="server" GridLines="None" AutoGenerateColumns="False" CssClass="table table-bordered" OnRowCommand="grdview_CriteriaList_RowCommand" AllowPaging="True" OnPageIndexChanging="grdview_CriteriaList_PageIndexChanging" PageSize="5">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Options">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="btn_EditCriteria" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "~/Admin/EditCriteria.aspx?sid=" + Eval("criteria_id") %>'>
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                            </asp:HyperLink>
                                            <asp:LinkButton ID="btn_DeleteCriteria" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" CommandArgument='<%# Eval("criteria_id") %>' CommandName="DeleteRow">
